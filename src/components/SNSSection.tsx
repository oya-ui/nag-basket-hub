const SNSSection = () => {
  return (
    <section id="sns" className="py-24 px-4 bg-muted">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center gap-3 bg-card text-card-foreground border border-border px-8 py-4 rounded-xl font-sans font-medium hover:bg-secondary transition-colors"
          >
